...
const AddInquiryFromCSV = () => {
  ...
  const downloadCSVHandler = () => {
    ...
    makeElement("th", "message", row);

    let dummyRow = makeElement("tr");
    makeElement("td", "Rocky", dummyRow);
    makeElement("td", "rocky@gmail.com", dummyRow);
    makeElement("td", "Test Message", dummyRow);

    thead.appendChild(row);
    thead.appendChild(dummyRow);

    tableToCSV("inquiries.csv", table);
  };
...
export default AddInquiryFromCSV;
