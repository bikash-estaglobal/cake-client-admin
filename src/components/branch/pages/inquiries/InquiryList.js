...
const InquiryList = (props) => {
  ...
  const [isAllInquiriesLoaded, setIsAllInquiriesLoaded] = useState(false);
  ...
  const deleteSubmitHandler = () => {
    ...
    fetch(`${Config.SERVER_URL}/inquiries/${deleteId}`, {
      method: "DELETE",
  ...
  useEffect(() => {
    setIsAllInquiriesLoaded(false);
    fetch(
      `${Config.SERVER_URL}/inquiries?skip=${pagination.skip}&limit=${
        pagination.limit
      }&q=${searchQuery || null}`,
      {
        method: "GET",
      ...
      .then(
        (result) => {
          setIsAllInquiriesLoaded(true);
          if (result.status === 200) {
            setAllInquiries(result.body || []);
          } else {
            M.toast({ html: result.message, classes: "bg-danger" });
          }
        },
  ...
  useEffect(() => {
    fetch(
      `${Config.SERVER_URL}/inquiries?skip=0&limit=0&q=${searchQuery || null}`,
      {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
                ...
                <div className="d-flex justify-content-between">
                  ...
                  <div className="">
                    <Link
                      ...
                      to={{
                        pathname: "/branch/inquiry/addByCSV",
                      }}
                    >
                    ...
                    <Link
                      className="btn btn-info rounded mr-2"
                      to={{
                        pathname: "/branch/inquiry/editByCSV",
                      }}
                    >
                              ...
                              <tr key={index}>
                                ...
                                <td className="text-center">
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/inquiry/edit/${data._id}`,
                                    }}
                                  >
                                    <span
