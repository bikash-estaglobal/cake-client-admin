...
const OccasionList = (props) => {
  ...
  const [isAllOccasionsLoaded, setIsAllOccasionsLoaded] = useState(false);
  ...
  useEffect(() => {
    setIsAllOccasionsLoaded(false);
    fetch(
      `${Config.SERVER_URL}/occasions?skip=${pagination.skip}&limit=${
        pagination.limit
      ...
      .then(
        (result) => {
          setIsAllOccasionsLoaded(true);
          if (result.status === 200) {
            setAllOccasions(result.body || []);
          } else {
            M.toast({ html: result.message, classes: "bg-danger" });
          }
        },
  ...
  useEffect(() => {
    fetch(
      `${Config.SERVER_URL}/occasions?skip=0&limit=0&searchQuery=${
        searchQuery || null
      }`,
      {
        method: "GET",
  ...
  return (
    <div className="page-wrapper px-0 pt-0">
      <div className={"container-fluid"}>
        ...
        <Breadcrumb title={"OCCASIONS"} pageTitle={"Occasion List"} />
                ...
                <div className="row">
                  ...
                  <div className="col-md-6 text-right">
                    <Link
                      ...
                      to={{
                        pathname: "/branch/occasion/addByCSV",
                      }}
                    >
                    ...
                    <Link
                      className="btn btn-info rounded mr-2"
                      to={{
                        pathname: "/branch/occasion/editByCSV",
                      }}
                    >
                            ...
                            return (
                              <tr key={index}>
                                ...
                                <td>
                                  ...
                                  >
                                    {occasion.status ? "Active" : "Disabled"}
                                  </span>
                                </td>
                                <td>
                                  {date.format(
                                ...
                                <td className="text-center">
                                  ...
                                  <Link
                                    ...
                                    to={{
                                      pathname: `/branch/occasion/edit/${occasion.id}`,
                                    }}
                                  >
                                    <span
